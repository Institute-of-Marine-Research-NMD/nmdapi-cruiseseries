package no.imr.nmdapi.nmdcruiseseries.full;
...
public class TestFull {
    ...
    public void setUp() throws Exception {
        ...
        FileUtils.deleteDirectory(new File(System.getProperty("java.io.tmpdir") + File.separator + "cruiseseries" + File.separator));
    ...
    public void testFull() throws Exception {
        ...
        mockMvc.perform(
                ...
                .content(FileUtils.readFileToString(new File(this.getClass().getClassLoader().getResource("cruiseseries_1.xml").getFile()), "UTF-8"))
                )
                .andDo(print())
                .andExpect(status().isOk());

        // Verify that data is there.
        final String insertedFile = FileUtils.readFileToString(new File(this.getClass().getClassLoader().getResource("cruiseseries_1.xml").getFile()), "UTF-8");
        ...
        mockMvc.perform(
                ...
                .contentType(MediaType.APPLICATION_XML)
                .characterEncoding("UTF-8")
                .content(FileUtils.readFileToString(new File(this.getClass().getClassLoader().getResource("cruiseseries_2.xml").getFile()), "UTF-8"))
                )
                .andExpect(status().isOk());

        // Verify that data is there.
        String updatedFile = FileUtils.readFileToString(new File(this.getClass().getClassLoader().getResource("cruiseseries_2.xml").getFile()), "UTF-8");
    ...
    public void testFailure() throws Exception {
        ...
        mockMvc.perform(
                ...
                .contentType(MediaType.APPLICATION_XML)
                .characterEncoding("UTF-8")
                .content(FileUtils.readFileToString(new File(this.getClass().getClassLoader().getResource("cruiseseries_failure.xml").getFile()), "UTF-8"))
                )
