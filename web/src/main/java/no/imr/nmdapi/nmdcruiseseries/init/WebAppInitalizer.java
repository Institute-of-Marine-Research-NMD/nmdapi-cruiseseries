package no.imr.nmdapi.nmdcruiseseries.init;
...
public class WebAppInitalizer extends AbstractDispatcherServletInitializer {
    ...
    protected WebApplicationContext createServletApplicationContext() {
        ...
        ctx.scan("no.imr.nmdapi.nmdcruiseseries.controller");
    ...
    public void onStartup(ServletContext servletContext) throws ServletException {
        ...
        try {
            InitalizeLogbackHandler.getInstance().initalize(System.getProperty("catalina.base") + "/conf/nmdapi_cruiseseries_logback_v1.xml", true);
